...
<div class="sidebar" id="sidebar">
    ...
    <aside class="side-menu">
        ...
        <div class="menu-item {% if app.request.get('_route') == 'app_gestion_tech' %}active{% endif %}">
            <img src="{{ asset('images/donnees/technicien.png') }}" alt="Technicien" class="menu-icon">
            <a href="{{ path('app_gestion_tech', { role: role }) }}">Gestion des techniciens</a>
        </div>
